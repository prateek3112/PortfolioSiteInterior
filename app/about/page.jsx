                ...
                <div className="flex items-center gap-x-8 lg:flex-row-reverse">
                    ...
                    <div className="">
                        <p className="pb-8 tracking-wide">
                            ...
                            Crafted with precision and passion, our Unfolding Box stands as a testament to our dedication. Designed to house and exhibit the exquisite portfolio of our second-year architecture endeavors, it symbolizes our unwavering commitment to excellence and creativity.
                            <br />
                            <br />
                        </p>
